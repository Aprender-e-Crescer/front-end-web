...
function Card({ cards }: Cardsprops) {
  return (
    <section className="flex justify-around flex-wrap gap-8 p-20 break-normal">
      {cards.map((card, index) => (
        ...
        >
          <div className="w-72 h-52 bg-orange-500 flex justify-center items-center rounded-lg  transform hover:scale-105 transition-transform duration-300">
            <div className="bg-yellow-300 w-60 h-44 flex justify-center items-center rounded-lg  transform hover:scale-105 transition-transform duration-300">
