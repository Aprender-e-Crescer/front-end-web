    ...
    <section className="bg-transparen p-16">
      <div className="max-w-[1000px] h-automy-8 py-0 mx-auto px-4">
        <div className="w-full  mx-auto">
          <Carousel className="h-96" leftControl={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="white" className="w-10 h-10 bg-gray-300 rounded-full">
...
rightControl={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="white" className="w-10 h-10 bg-gray-300 rounded-full">
