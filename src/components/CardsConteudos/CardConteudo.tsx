  ...
  return (
    <section>
      ...
      <div className="flex justify-around mt-8 ml-5 items-center flex-wrap   text-center ">
        <span className="p-6 rounded-xl border-25  border-solid border-y-orange-500 border-x-yellow-400 w-full md:w-1/2 lg:w-1/3 text-indigo-900 font-semibold text-xl md:text-lg lg:text-xl xl:text-2xl">
          {subContent}
        </span>
